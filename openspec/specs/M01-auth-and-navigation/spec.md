...
Real sign-in, session persistence, and capability-based routing — the entry point
every other screen in the app sits behind. Backfilled 2026-07-17 to document the
M01 skeleton commit's (`5f4ff49`, 2026-07-12) real, already-shipped behavior; no
